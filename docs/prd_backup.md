...
- NFR1: The application shall load completely within 2 seconds on standard broadband connection (10Mbps+)
...
- NFR7: The application shall function fully offline after initial load, using browser-based processing
...
Single repository containing web application with potential for future mobile apps and backend services. Organized with packages/ directory for shared components and future service modules.

### Service Architecture

Static site architecture with client-side processing for core features. All image processing happens in browser using Canvas API and Web Workers for optimal performance. CDN deployment for global performance. Backend services will be integrated for user accounts, cloud storage, and collaboration features in Phase 2.
...
- **Deployment**: Static hosting on Vercel or Netlify with automatic preview deployments
- **Analytics**: Privacy-focused analytics (Plausible or Umami) for usage insights
- **Error Tracking**: Sentry integration for production error monitoring

## Epic List

- **Epic 1: Foundation & Core Upload System** - Establish project infrastructure, implement file upload system, and display images on canvas with basic zoom/pan controls
...
**Goal**: Establish the technical foundation and core infrastructure while delivering immediate value through a functional image upload and display system. Users will be able to upload screenshots and view them on an interactive canvas, providing the essential groundwork for all enhancement features.
...
1. Vite project initialized with React 18 and TypeScript configuration
2. Tailwind CSS integrated with custom design tokens for colors and spacing
3. ESLint and Prettier configured with agreed code style rules
4. Git repository initialized with proper .gitignore and branching strategy
5. Basic folder structure created (components/, hooks/, utils/, types/)
6. Development and build scripts functional with hot-reload working
7. Basic health check route/page displays "Scroma - Screenshot Mockup Tool"
...
✅ Non-functional requirements address performance and compatibility
✅ UI/UX goals align with target user needs
✅ Technical assumptions documented with rationale
✅ Epic structure follows logical progression
...
✅ Browser-based approach validated for performance requirements
...
✅ Performance constraints addressed with optimization stories
...
"Please review the Scroma PRD and create detailed UX specifications. Focus on the editor canvas layout, frame selector interface, and gradient builder components. Provide wireframes for the core screens identified in the PRD, ensuring the 'professional simplicity' vision is achieved. Use docs/prd.md as your primary input."

### Architect Prompt

"Please create the technical architecture document for Scroma using the PRD at docs/prd.md. Design a scalable React/TypeScript application with Fabric.js canvas manipulation, focusing on client-side performance optimization. Include component hierarchy, state management patterns, and build configuration for the static site architecture specified in the requirements."
